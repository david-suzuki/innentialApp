...
#####
DEFAULT_SSH_KEY=$PRODUCTION_DEFAULT_SSH_KEY
SERVER_NAME="${APP_NAME}_server"
SSH_CONN=$PRODUCTION_SERVER_USER@$PRODUCTION_SERVER_HOST
####
...
DOCKER_SERVER_ENV="-e SERVER_NAME=$PRODUCTION_LABEL"
...
ADMIN_DOMAIN=$PRODUCTION_ADMIN_DOMAIN
GRAPHQL_DOMAIN=$PRODUCTION_GRAPHQL_DOMAIN
FORCE_SSL=""
############################################
if [ "$PRODUCTION_FORCE_SSL" == 'true' ]; then
