...
export const goalItemStyle = css.global`
  .goal-item {
    position: relative;
    display: flex;
    gap: 30px;
  ...
  .item__content__button-container:after, .item__content__button-container:before {
    content: '';
    height: 10px;
    width: 2px;
  ...
  .item__content__button-container:after {
    transform: rotate(45deg);
    position: relative;
    right: 2px;
  }

  .item__content__button-container:before {
    transform: rotate(-45deg);
  }
