...
const adminEventsTableStyle = css.global`
  .events-table__container {
    margin-top: 14px;
  }
  ...
  svg.table-icon {
    fill: ${variables.desaturatedBlue};
  }
  ...
  .path-data {
    font-size: 14px;
    line-height: 22px;
    color: ${variables.veryDarkBlue} !important;
  }
  ...
  .path-data__buttons button span {
    font-size: 12px;
    font-family: Poppins;
    line-height: 18px;
    letter-spacing: .1px;
  ...
  .path-data__buttons button:hover {
    color: ${variables.white};
    background: ${variables.gold};
    border-color: ${variables.gold};
  }

  .path-data__buttons .action-button {
    color: ${variables.success80};
    border-color: ${variables.success80};
  }

  .path-data__buttons .action-button:hover {
    color: ${variables.white};
    background: ${variables.success80};
    border-color: ${variables.success80};
  }

  .path-data__delete-icon {
    cursor: pointer;
  }

  .path-data__delete-icon path {
    fill: ${variables.error60};
  }
  ...
  .path-data__attendees img {
    border-radius: 50%;
    box-sizing: content-box;
    border: 3px solid #ffffff;
  }

  .path-data__attendees img:not(:first-child) {
    margin-left: -16px;
  }
  ...
  .table tr:nth-child(2) td {
      padding: 26px 0px 2px !important;
  }
...
export default adminEventsTableStyle
