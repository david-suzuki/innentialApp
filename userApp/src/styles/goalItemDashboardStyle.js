...
export const goalItemDashboardStyle = css.global`
  .goal-item {
    position: relative;
    display: flex;
    gap: 30px;
  ...
  .goal-item--completed {
    ...
    border-radius: 4px;
    margin-bottom: 45px;
    box-shadow: rgb(0 0 0 / 5%) 0px 6px 11px 5px;
    position: relative;
  ...
  .goal-item__goal-number {
    position: absolute;
    background-color: rgb(90, 85, 171);
    border-radius: 50%;
    width: 40px;
    height: 40px;
    line-height: 40px;
...
`
export default goalItemDashboardStyle
