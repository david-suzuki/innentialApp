...
const protocol = localAuthCheck() ? 'http' : 'https'
...
export const startupMessages = () => {
  ...
  console.log(
    `GraphQL Server is now running on ${protocol}://localhost:${PORT}/graphql`
  )
  console.log(`View GraphiQL at ${protocol}://localhost:${PORT}/graphiql`)
}
